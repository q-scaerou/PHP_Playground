...
<html lang="en">
    ...
    <body>
        ...
        <?php
            ...
            $mysqlExportPath ='C:/wamp64/www/Projet/SQL/Base_PiCO.sql';

            //Exportation de la base de données
            $command='C:\\wamp64\\bin\\mysql\\mysql5.7.36\\bin\\mysqldump --opt -h' .$mysqlHostName .' -u' .$mysqlUserName .' -p' .$mysqlPassword .' ' .$mysqlDatabaseName .' > ' .$mysqlExportPath;
            system($command, $output);
        ?>

            <div class="mx-4">
                <h3 class="text-center">La base de données PiCO a bien été sauvegardée <i class="bi bi-check2-circle"></i></h3>
            </div>
