...
<html lang="en">
    ...
    <body>
        ...
        <header class="">
            ...
            <div class="mx-4">
                <h3 class="text-center">Item bien supprimé ! <i class="bi bi-trash"></i></h3>
            </div>
        ...
        <?php
            $deleteRow=$mysqlClient->prepare('DELETE FROM inventory WHERE id = ?');
            $deleteRow->execute(array($_POST['delete_id']));
        ?>
