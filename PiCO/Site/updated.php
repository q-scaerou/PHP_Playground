...
<html lang="en">
    ...
    <body>
        ...
        <header class="">
            ...
            <div class="mx-4">
                <h3 class="text-center">Item bien modifié ! <i class="bi bi-check2-circle"></i></h3>
            </div>
        ...
        <?php
            $new_entry=$mysqlClient->prepare('UPDATE inventory SET num_inventaire = ?, mode_acquisition = ?, nom_donateur = ?, date_acquisition = ?,
            instanc_scientifique = ?, prix_achat_subvention = ?, date_affec = ?, designation = ?, inscriptions = ?, matiere = ?, technique = ?,
            mesures = ?, etat = ?, auteur = ?, datation = ?, fonction_usage = ?, prov_geo = ?, observations = ? WHERE id = ?');
            $new_entry->execute(array($_POST['invnumber'], $_POST['mod_acquisition'], $_POST['donator'], $_POST['date_acquisition'],
            ...
            $_POST['prov_geo'], $_POST['domain'].", ".$_POST['observation'], $_POST['update_id']));
        ?>
        ...
        <?php
            ...
            $addedStatement->execute(array($_POST['update_id']));
