    ...
    <body>
        ...
        <header class="">
            ...
            <div class="mt-2 ml-2">
                ...
                <button class="btn btn-dark justify-content-right" onclick="window.location.href='./lendhistory.php';">Historique des Prêts</button>
                <button class="btn btn-dark justify-content-right" onclick="window.location.href='./newlend.php';">Créer un Prêt</button>
            </div>
            <div class="mx-4">
        ...
        <?php
            ...
            $lendStatement = $mysqlClient->prepare('SELECT Prets.*, Inventory.num_inventaire FROM Prets LEFT JOIN Inventory ON id = inventory_id WHERE estencours = TRUE;');
        ...
        <table class="table table-striped">
            <thead class="thead-dark">
                <tr>
                    ...
                    <th scope="col">Date de fin (estimée)</th>
                ...
                <tr>
                    <td scope="row">
                        <div class="row">
                            ...
                            <form action="lendend.php" method="POST" onsubmit="return confirm('Ce prêt sera considéré comme clos.');">
                            <input type="hidden" name="back_id" value=<?php echo $item['inventory_id']; ?> >
                                <button class="btn btn-dark smallrdbtn" title="Marquer comme terminé">
                    ...
                    <td>
                        <?php 
                        $today = date('Y-m-d');
                        if ($today < $item['date_retour_estimee']) {
                            echo "OK";
                        } else {
                            echo "RETARD - Contactez ".$item['destination'].", ".$item['ville'];
                        }
                       ?>
                    </td>
                </tr>
